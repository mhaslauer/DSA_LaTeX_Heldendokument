...
\def \TalentKampfExtraAAT{14}
\def \TalentKampfExtraAPA{10}
\def \TalentKampfExtraATaWL{+8}
...
\def \TalentKampfExtraDAT{16}
\def \TalentKampfExtraDPA{-}
\def \TalentKampfExtraDTaWL{+8}
...
\def \TalentKampfExtraEAT{13}
\def \TalentKampfExtraEPA{-}
\def \TalentKampfExtraETaWL{+5}
...
\def \TalentKoerperbeherrschungTaWL{+2} % Körperbeherrschung
...
\def \TalentSinnesschaerfeTaWL{+7} % Sinnesschärfe
...
\def \TalentSagenLegendenTaWL{+3} % Sagen/Legenden
...
\def \TalentHeilkundeWundenTaWL{+6} % Heilkunde Wunden
...
\def \WaffeFernkampfBFK{16}
\def \WaffeFernkampfBGeschosseA{18}
...
\def \AusruestungLinksBGewicht{3x}
...
\def \AusruestungLinksCGewicht{1}
...
\def \AusruestungLinksDGewicht{2x}
...
\def \AusruestungLinksEGewicht{1x}
...
\def \AusruestungLinksG{Tiegel mit lehmigem Inhalt}
...
% Vermögen
\def \VermoegenDukaten{9}
\def \VermoegenSilbertaler{19}
