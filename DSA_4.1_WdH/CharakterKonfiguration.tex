...
\def \TalentKampfExtraDAT{18}
\def \TalentKampfExtraDPA{-}
\def \TalentKampfExtraDTaWL{+10}
...
\def \TalentAthletikTaWL{+3} % Athletik
...
\def \TalentSinnesschaerfeTaWL{+10} % Sinnesschärfe
...
\def \TalentWildnislebenTaWL{+8} % Wildnisleben
...
\def \TalentHandwerkExtraBTaWL{+3}
...
\def \SonderfertigkeitenNahkampfB{Finte} % Nahkampf Sonderfertigkeiten (2. Zeile)
\def \SonderfertigkeitenNahkampfC{Ausweichen I} % Nahkampf Sonderfertigkeiten (3. Zeile)
...
\def \WaffeFernkampfBFK{18}
\def \WaffeFernkampfBGeschosseA{24}
...
\def \RuestungSummeRS{2}
\def \RuestungSummeBE{2}
\def \RuestungsgewoehnungWert{0}

%----------------------------
%	Ausweichen
\def \AusweichenSumme{9}
...
\def \AusruestungRechtsG{Beinschienen (Leder, beschlagen) (0.3/0.3)}
\def \AusruestungRechtsGGewicht{?}
\def \AusruestungRechtsGWoGetragen{Rucksack}
...
% Vermögen
\def \VermoegenDukaten{83}
\def \VermoegenSilbertaler{25}
\def \VermoegenHeller{6}
